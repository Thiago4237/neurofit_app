...
# (str) Package name
package.name = neurofit

# (str) Package domain (needed for android/ios packaging)
package.domain = org.neurofit
...
source.include_patterns = data/models/*.tflite,data/models/*.json,src/kvs/*.kv
source.include_dirs = src,data
...
requirements = python3,kivy==2.3.1,kivymd==1.2.0,numpy,tflite-runtime
...
android.ndk_path = /home/santiago/.buildozer/android/platform/android-ndk-r28c

# (str) Android SDK directory (if empty, it will be automatically downloaded.)
android.sdk_path = /home/santiago/.buildozer/android/platform/android-sdk
